...
pub const INITIAL_BALANCE: <Test as pallet_balances::Config>::Balance = 42000;
...
pub type Time = pallet_timestamp::Pallet<Test>;
...
impl RuntimeBuilder {
    ...
    pub fn build(self) -> sp_io::TestExternalities {
        ...
        let move_stdlib =
            include_bytes!("../../../pallets/sp-mvm/tests/assets/move-stdlib/build/MoveStdlib/bundles/MoveStdlib.pac")
                .to_vec();
        let pont_framework =
            include_bytes!("../../../pallets/sp-mvm/tests/assets/pont-stdlib/build/PontStdlib/bundles/PontStdlib.pac")
                .to_vec();
