...
pub mod pallet {
                        ...
                        .filter_map(|d| {
                            if d.owner != delegator {
                                ...
                                top_delegations.total =
                                    top_delegations.total.saturating_sub(d.amount);
                                delegation_option = Some(Bond {
                                    owner: d.owner,
        ...
        > Delegator<AccountId, Balance>
    {
        ...
        pub fn can_execute_leave<T: Config>(
            &self,
            delegation_weight_hint: u32,
        ) -> DispatchResult {
            ensure!(
    ...
    impl<T: Config> Hooks<BlockNumberFor<T>> for Pallet<T> {
        fn on_initialize(n: T::BlockNumber) -> Weight {
            ...
            if round.should_update(n) {
                ...
                weight += T::WeightInfo::round_transition_on_initialize(
                    collator_count,
                    delegation_count,
                );
            }
    ...
    pub type InflationConfig<T: Config> =
        StorageValue<_, InflationInfo<BalanceOf<T>>, ValueQuery>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn execute_leave_candidates(
            ...
            let bottom_delegations = <BottomDelegations<T>>::take(&candidate)
                .expect("CandidateInfo existence checked");
